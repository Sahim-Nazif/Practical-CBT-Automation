...
public class Navigation {
	...
	public static void main(String[] args) {
		...
		//the difference between get() and navigate().to() is that get is used to navigate particular ULR
		// and wait till page load
		//navigate().to() is used to navigate to particular URL and doesn't wait for page load.
